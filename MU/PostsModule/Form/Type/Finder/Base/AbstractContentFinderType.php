...
namespace MU\PostsModule\Form\Type\Finder\Base;
...
/**
 * Content finder form type base class.
 */
abstract class AbstractContentFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('categories', CategoriesType::class, [
            ...
            'entityCategoryClass' => 'MU\PostsModule\Entity\\' . ucfirst($options['object_type']) . 'CategoryEntity',
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the content') => 1,
                $this->__('Absolute url to the content') => 2,
                $this->__('ID of content') => 3
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    {
        return 'mupostsmodule_contentfinder';
    }
