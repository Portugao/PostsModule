...
use MU\PostsModule\Helper\CollectionFilterHelper;

/**
 * Repository class used to implement own convenience methods for performing certain DQL queries.
 *
 * This is the base repository class for content entities.
 */
abstract class AbstractContentRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\PostsModule\Entity\ContentEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUPostsModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'contents', 'userid' => $userId];
     ...
     *
     * @return array|contentEntity Retrieved data array or contentEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved contentEntity instances
     */
     ...
     *
     * @return MU\PostsModule\Entity\ContentEntity Retrieved instance of MU\PostsModule\Entity\ContentEntity
     *
     * @throws InvalidArgumentException Thrown if invalid parameters are received
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('content', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('content', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numContents';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('content', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of contents to exclude (optional)
     *
     * @return boolean Result of this check, true if the given content does not already exist
     */
