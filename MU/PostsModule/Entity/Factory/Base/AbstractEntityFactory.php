...
use MU\PostsModule\Entity\Factory\EntityInitialiser;
...
abstract class AbstractEntityFactory
{
    ...
    {
        $entityClass = 'MU\\PostsModule\\Entity\\' . ucfirst($objectType) . 'Entity';
     ...
     *
     * @return MU\PostsModule\Entity\contentEntity The newly created entity instance
     */
    public function createContent()
    {
        $entityClass = 'MU\\PostsModule\\Entity\\ContentEntity';

        $entity = new $entityClass();

        $this->entityInitialiser->initContent($entity);
    ...
    public function getIdField($objectType = '')
    {
        ...
        $entityClass = 'MUPostsModule:' . ucfirst($objectType) . 'Entity';
