...
use MU\PostsModule\Helper\NotificationHelper;
...
abstract class AbstractWorkflowEventsListener implements EventSubscriberInterface
{
    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        $hasApproval = in_array($objectType, ['content']);
        ...
        if (!$this->permissionApi->hasPermission('MUPostsModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
    ...
    public function onEnter(Event $event)
    {
        ...
        if (in_array($entity->get_objectType(), ['content'])) {
