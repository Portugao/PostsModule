...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from posts app';
     *     $event->getRequest()->attributes->set('MUPostsModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUPostsModule_test');`
     *     now `$testMessage` should be: `'Hello from posts app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('posts App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
