...
function mUPostsReadDate(val, includeTime) {
...
function mUPostsValidateNoSpace(val) {
    var valStr;
 ...
 */
function mUPostsExecuteCustomValidationConstraints(objectType, currentEntityId) {
}
