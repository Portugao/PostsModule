...
abstract class AbstractAjaxController extends AbstractController
{
    ...
    {
        if (!$this->hasPermission('MUPostsModule::Ajax', '::', ACCESS_EDIT)) {
            return true;
        }
        
        $objectType = $request->query->getAlnum('ot', 'content');
        ...
        $entityDisplayHelper = $this->get('mu_posts_module.entity_display_helper');
    ...
    protected function prepareSlimItem($repository, $objectType, $item, $itemId, $descriptionField)
    {
        ...
        $previewParameters = $this->get('mu_posts_module.controller_helper')->addTemplateParameters($objectType, $previewParameters, 'controllerAction', $contextArgs);
    
        $previewInfo = base64_encode($this->get('twig')->render('@MUPostsModule/External/' . ucfirst($objectType) . '/info.html.twig', $previewParameters));
    
        $title = $this->get('mu_posts_module.entity_display_helper')->getFormattedTitle($item);
