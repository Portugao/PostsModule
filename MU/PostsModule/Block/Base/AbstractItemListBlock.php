...
namespace MU\PostsModule\Block\Base;

use Zikula\BlocksModule\AbstractBlockHandler;
use Zikula\Core\AbstractBundle;
use MU\PostsModule\Helper\FeatureActivationHelper;
use MU\PostsModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function __construct(AbstractBundle $bundle)
    {
        ...
        $this->categorisableObjectTypes = ['content'];
    }
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUPostsModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        // create query
        $orderBy = $this->get('mu_posts_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('mu_posts_module.category_helper');
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('MUPostsModule items');
        }
        ...
        $templateParameters = $this->get('mu_posts_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    protected function getDisplayTemplate(array $properties = [])
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@MUPostsModule/' . $templatePath)) {
                $template = '@MUPostsModule/' . $templatePath;
                break;
            }
        }
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('mu_posts_module.category_helper'),
            'feature_activation_helper' => $this->get('mu_posts_module.feature_activation_helper')
        ];
    }
    ...
    {
        return '@MUPostsModule/Block/itemlist_modify.html.twig';
    }
